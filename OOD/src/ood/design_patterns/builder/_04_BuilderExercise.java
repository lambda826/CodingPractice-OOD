package ood.design_patterns.builder;
...
public class _04_BuilderExercise {
    private Class theClass = new Class();

    public _04_BuilderExercise(String rootName) {
        theClass.name = rootName;
    }

    public _04_BuilderExercise addField(String name, String type) {
